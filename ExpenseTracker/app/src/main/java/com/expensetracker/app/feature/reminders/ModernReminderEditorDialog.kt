...
fun ModernReminderEditorDialog(
        ...
        Surface(
            ...
            Column(
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    DateTimeCard(Modifier.weight(1f), { Icon(Icons.Default.DateRange, null) }, "Date", DateFormat.getDateInstance(DateFormat.MEDIUM).format(Date(selectedDate))) { showDate = true }
                    DateTimeCard(Modifier.weight(1f), { Icon(Icons.Default.AccessTime, null) }, "Time", DateFormat.getTimeInstance(DateFormat.SHORT).format(Date(selectedTime))) { showTime = true }
                }
                ...
                Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                    ...
                    Button(
                        ...
                        onClick = {
                            ...
                            onSave(title.trim(), note.trim(), calendar.timeInMillis, recurrence, intervalDays.toInt())
                        },
    ...
    if (showDate) {
        ...
        DatePickerDialog(
            ...
            confirmButton = { TextButton(onClick = { state.selectedDateMillis?.let { selectedDate = it }; showDate = false }) { Text("Done") } },
